...
public class Surrounded implements AsciiBlock {
  ...
  /**
   * Determine if another Surrounded block is structurally
   * equivalent to this block.
   * @param other
   *   The Surrounded block to compare to this block.
   * @return true if the two blocks are structurally equivalent and
   *    false otherwise.
   */
  public boolean eqv(Surrounded other) {
    return this.surroundChar == other.surroundChar
